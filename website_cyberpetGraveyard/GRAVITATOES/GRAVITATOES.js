...
function gravitato_makepotato(potatonum){
	var arr_tatoes = ["IMG_BONE_1.gif", "IMG_BONE_2.gif", "IMG_BONE_3.gif", "IMG_BONE_4.gif", "IMG_BONE_5.gif", "IMG_BONE_6.gif", "IMG_BONE_7.gif", "IMG_BONE_8.gif", "IMG_BONE_9.gif", "IMG_BONE_10.gif", "IMG_BONE_11.gif", "IMG_BONE_12.gif", "IMG_BONE_13.gif", "IMG_BONE_14.gif", "IMG_BONE_15.gif", "IMG_BONE_16.gif", "IMG_BONE_17.gif", "IMG_BONE_18.gif", "IMG_BONE_19.gif", "IMG_BONE_20.gif", "IMG_BONE_21.gif", "IMG_BONE_22.gif", "IMG_BONE_23.gif", "IMG_BONE_24.gif", "IMG_BONE_25.gif"];
	var str_tato = arr_tatoes[Math.ceil(Math.random()*arr_tatoes.length)-1];
	//make a good potato
	var potatovar;
	...
	potatovar.innerHTML = '<img src=' + str_img_pathtato + str_tato + '>';
